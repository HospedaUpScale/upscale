...
export default function LGPDPage() {
  return (
    <LegalDocLayout
      ...
      subtitle="Proteção de Dados Pessoais (LGPD)"
      sections={sections}
      lastUpdated="15 de setembro de 2026"
    >
      <LegalSection id="introducao" title="1. Introdução">
        <p>
          A <strong className="text-slate-900">Upscale LTDA</strong>, inscrita no CNPJ sob o nº 63.864.519/0001-38,
          ...
          empresa&quot;), respeita a privacidade de quem visita nosso site e de quem se relaciona com nossos
          serviços de assessoria em WhatsApp Marketing.
        </p>
        <p>
          Esta Política de Privacidade descreve como coletamos, usamos, armazenamos, compartilhamos e protegemos os
          dados pessoais de visitantes, leads, clientes e contatos das operações que administramos, em conformidade
          com a Lei nº 13.709/2018 (Lei Geral de Proteção de Dados Pessoais — &quot;LGPD&quot;) e demais normas
          aplicáveis. Ao utilizar nosso site ou fornecer seus dados por qualquer canal, você declara estar ciente e
          de acordo com as práticas descritas neste documento.
        </p>
      </LegalSection>
      ...
      <LegalSection id="definicoes" title="2. Definições">
        <ul className="list-disc space-y-2 pl-5">
          <li>
            <strong className="text-slate-900">Dado pessoal:</strong> qualquer informação relacionada a pessoa
            natural identificada ou identificável, como nome, e-mail, telefone e número de WhatsApp.
          </li>
          <li>
            <strong className="text-slate-900">Dado pessoal sensível:</strong> dado sobre origem racial ou étnica,
            convicção religiosa, opinião política, filiação sindical, dado de saúde ou vida sexual, dado genético
            ou biométrico. A Upscale não coleta, de forma intencional, dados sensíveis por meio de seus canais.
          </li>
          <li>
          ...
          <li>
            <strong className="text-slate-900">Tratamento:</strong> toda operação realizada com dados pessoais,
            como coleta, produção, recepção, classificação, uso, acesso, armazenamento, eliminação, transmissão e
            compartilhamento.
          </li>
          <li>
            <strong className="text-slate-900">Controlador:</strong> a Upscale, quando define as finalidades e a
            forma do tratamento dos dados coletados em seus próprios canais.
          </li>
          <li>
            <strong className="text-slate-900">Operador:</strong> a Upscale, quando trata dados pessoais por conta
            e conforme as instruções de um cliente contratante, no âmbito da prestação do serviço de assessoria em
            WhatsApp Marketing.
          </li>
        </ul>
      </LegalSection>

      <LegalSection id="coleta" title="3. Como coletamos seus dados">
      ...
      <LegalSection id="finalidades" title="4. Para que usamos seus dados">
      ...
      <LegalSection id="cookies" title="5. Cookies">
        <p>
          ...
          preferências, viabilizar funcionalidades do site e produzir estatísticas de uso e desempenho. Você pode
          configurar seu navegador para bloquear ou alertar sobre a presença de cookies; a desativação pode, no
          entanto, afetar o funcionamento de algumas partes do site.
        </p>
      </LegalSection>

      <LegalSection id="plataformas-terceiros" title="6. Plataformas e serviços de terceiros">
        <p>
          A operação de nossos serviços envolve o uso de plataformas de terceiros, como a API oficial do WhatsApp
          Business (Meta), ferramentas de automação, provedores de hospedagem e infraestrutura de tecnologia. Essas
          plataformas possuem políticas de privacidade próprias, que recomendamos consultar. A Upscale não se
          responsabiliza por práticas de tratamento de dados realizadas por terceiros fora de nossa orientação ou
          controle.
        </p>
      </LegalSection>

      <LegalSection id="compartilhamento" title="7. Com quem compartilhamos seus dados">
        <p>Podemos compartilhar dados pessoais com:</p>
        <ul className="list-disc space-y-2 pl-5">
          <li>
            Prestadores de serviços de tecnologia, hospedagem, automação e mensageria necessários à execução das
            campanhas (ex.: Meta/WhatsApp Business Platform);
          </li>
      ...
      <LegalSection id="bases-legais" title="8. Bases legais do tratamento">
            ...
            <tbody className="divide-y divide-slate-100 text-slate-600">
              ...
              <tr>
                <td className="px-4 py-3">
                  Legítimo interesse em segurança, prevenção a fraudes e melhoria dos serviços
                </td>
      ...
      <LegalSection id="direitos" title="9. Seus direitos como titular">
      ...
      <LegalSection id="retencao" title="10. Prazo de retenção">
        <p>
          ...
          direitos em eventuais processos judiciais ou administrativos. Dados de navegação e cookies são mantidos
          por até 5 (cinco) anos, salvo prazo distinto exigido por lei específica. Encerradas as finalidades ou
          expirados os prazos legais aplicáveis, os dados são eliminados ou anonimizados, salvo hipóteses legais de
          conservação.
        </p>
      </LegalSection>

      <LegalSection id="autoridades" title="11. Compartilhamento com autoridades públicas">
        <p>
          Poderemos compartilhar dados pessoais com autoridades públicas, órgãos reguladores ou o Poder Judiciário
          quando exigido por lei, ordem judicial ou requisição de autoridade competente, observados os limites e
          garantias previstos na legislação aplicável.
        </p>
      </LegalSection>

      <LegalSection id="menores" title="12. Uso por menores de idade">
        <p>
          Nossos serviços e canais de contato são destinados a pessoas maiores de 18 (dezoito) anos. Não coletamos
          intencionalmente dados pessoais de crianças ou adolescentes. Caso identifiquemos dados pessoais de
          menores tratados sem o devido consentimento dos responsáveis legais, adotaremos as medidas cabíveis para
          sua eliminação.
        </p>
      </LegalSection>

      <LegalSection id="mensageria" title="13. Particularidades dos canais de mensageria">
        <p>
          ...
          Business (Meta). O conteúdo das mensagens trocadas pode ser processado por essas plataformas de acordo
          com suas próprias políticas de privacidade e retenção. Recomendamos que você também consulte a política
          de privacidade da Meta/WhatsApp para entender como seus dados são tratados nessas plataformas.
        </p>
      </LegalSection>

      <LegalSection id="ia" title="14. Uso de inteligência artificial">
        <p>
      ...
      <LegalSection id="opt-out" title="15. Como cancelar o recebimento de mensagens">
        <p>
          ...
          cancelamento será processado em prazo razoável, observadas eventuais limitações técnicas das plataformas
          utilizadas.
        </p>
      </LegalSection>

      <LegalSection id="seguranca" title="16. Segurança da informação">
        <p>
          Adotamos medidas técnicas e organizacionais razoáveis para proteger os dados pessoais sob nossa
          responsabilidade contra acessos não autorizados e situações acidentais ou ilícitas de destruição, perda,
          alteração, comunicação ou qualquer forma de tratamento inadequado ou ilícito, incluindo controle de
          acesso e boas práticas de armazenamento. Nenhum sistema é inteiramente livre de riscos; caso um incidente
          de segurança relevante seja identificado, adotaremos as medidas cabíveis e, quando exigido por lei,
          comunicaremos os titulares e a Autoridade Nacional de Proteção de Dados (ANPD).
        </p>
      </LegalSection>

      <LegalSection id="alteracoes" title="17. Alterações desta política">
        <p>
          Esta Política de Privacidade pode ser atualizada periodicamente para refletir mudanças em nossas
          práticas de tratamento de dados ou na legislação aplicável. A data da última atualização está indicada
          no topo desta página. Recomendamos a revisão periódica deste documento.
        </p>
      </LegalSection>

      <LegalSection id="contato" title="18. Contato e encarregado de dados">
        <p>
      ...
      <LegalSection id="foro" title="19. Legislação aplicável e foro">
        <p>
          Esta Política de Privacidade é regida pelas leis da República Federativa do Brasil, em especial pela Lei
          nº 13.709/2018 (LGPD). Fica eleito o foro da Comarca de Goiânia, Estado de Goiás, para dirimir quaisquer
          controvérsias decorrentes deste documento, com renúncia a qualquer outro, por mais privilegiado que seja.
        </p>
      </LegalSection>
    </LegalDocLayout>
  );
